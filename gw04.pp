class { 'ffnord::params':
  router_id => "10.71.7.1",  # The id of this router, probably the ipv4 address
...
ffnord::mesh { 'mesh_ffnh':
  ...
  , mesh_ipv6 => "fd8f:14c7:d318::ff04/64"
  , mesh_ipv4  => "10.71.7.1/19"        # ipv4 address of mesh device in cidr notation, e.g. 10.35.0.1/19
